...
--
--   SUPER + TAB        the zoomed-out canvas; type to search, Enter to go
  ...
  plugin = {
    spatialoverview = {
      ...
      canvas = {
        ...
        auto_float = true,
        auto_place = true,
        auto_fill = true, -- new app windows fill the screen below the bar
        placement_gap = 40,
        space_pan = false,
        direct_input = true,
        hover_focus = true,
...
hl.unbind("SUPER + TAB")
bind("SUPER + TAB", "Zoom out and search", function()
...
-- SUPER + N sends it without following, SHIFT + SUPER + TAB goes to the previous
-- place, SUPER + scroll goes next/previous, CTRL + SUPER + TAB goes back
